...
<body>
	...
	<div class="m-b-md">
			...
			<div class="form-group">
			   ...
			   <label class="control-label">项目名：  
                        <input type="text" class="form-control" id="projectName" name="ProjectShopsFormMap.projectName" placeholder="请输入项目名">
                    </label>     
 ...
 <div class="row">
	...
	<script type="text/javascript" src="js/system/project/shopslist.js"></script>
		</body>
