...
<script>
    ...
    $(".sjsubmit").click(function () {
        ...
        checkform("up_img1", "#box1", "#sj_img_box", homeId, 0)
    })

    // ajaxForm提交表单
    function checkform(objform, imgboxq, imgbox, homeId, imgarr) {
                        ...
                        success: function (res, error) {
                            ...
                            if (res !== null) {
                                ...
                                for (var i = 0; i < res.length; i++) {
                                    imghtml += '<tr> <td class="imgtd"><img src="../img/pro_home/' + homeId + '/' + res[i].img + '"></td> <td>' + res[i].img + '</td> <td onclick="Delimg(this,' + res[i].id + ')"><button class="btn btn-danger">删除</button></td>'
                                }
                                $(imgbox).html(imghtml)
                            }
                        }
    ...
    //图片回显
    function Setshowimg(imgbox, homeId) {
