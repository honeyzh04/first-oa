...
<script>
            ...
            var options = {
                ...
                success: function (data) {
                   layer.alert("提交成功");
                    ...
                    // if (data == "success") {
                        $.ajax({
                            url: "../projectShops/findImg.shtml?proId=" + proid + "&type=" + type,
                            type: 'get',
                            dataType: 'json',
                            success: function (res, error) {
                                ...
                                if (res !== null) {
                                    ...
                                    for (var i = 0; i < res.length; i++) {
                                        imghtml += '<tr> <td class="imgtd"><img src="../img/project/shops/' + proid+'/'+res[i].img + '"></td> <td>' + res[i].img + '</td> <td onclick="Delimg(this,' + res[i].id + ')"><button class="btn btn-danger">删除</button></td>'
                                    }
                                    $(imgbox).html(imghtml)
                                }
                            }
    ...
    function Delimg(obj, id) {
        ...
        if (con == true) {
            ...
            $.ajax({
                url: "../projectShops/deleteImg.shtml?id=" + id,
                type: 'get',
                dataType: 'json',
                success: function (res, error) {
