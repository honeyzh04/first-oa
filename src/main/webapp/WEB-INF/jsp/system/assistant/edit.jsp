...
<script type="text/javascript" src="${ctx}/js/system/assistant/edit.js">
...
<body>
	...
	<form id="form" name="form" class="form-horizontal" method="post"
		action="${ctx}/interlocution/editInterlocution.shtml">
		<input type="hidden" class="form-control checkacc"
			value="${interlocution.id}" name="interlocutionFormMap.id" id="id">
			<input type="hidden" class="form-control checkacc"
			value="${interlocution.qId}" name="interlocutionFormMap.qId" id="qId">
