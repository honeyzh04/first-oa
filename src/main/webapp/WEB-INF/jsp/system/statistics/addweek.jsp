            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="输入点击率" name="statisticsFormMap.click_rate">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="输入IP数量" name="statisticsFormMap.bounce_rate">
                        <span class="input-group-addon">个</span>
