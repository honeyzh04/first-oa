...
<script type="text/javascript" src="${ctx}/js/system/statistics/add.js">
        ...
        <input type="text" name="statisticsFormMap.createDate" id="createDate" >
            ...
            <div class="floatl">
            <label for="time">&nbsp;&nbsp;百度价格:</label>
        <input type="text" class="baiduprice"   name="statisticsFormMap.baidu_price"id="baiduprice">
            </div>
            <div class="floatl">
            <label for="time">&nbsp;&nbsp;百度点击:</label>
        <input type="text" class="baiduclick"   name="statisticsFormMap.baidu_click" id="baiduclick">
            </div>
            <div class="floatl">
