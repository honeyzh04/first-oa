			...
			<div class="row">
				...
				<div class="right-add col-sm-7 mt20 border">
					...
					<!-- 	<div class="form-group">
							...
							<textarea  style="resize:none"  name="customerFormMap.description" rows="3" cols="60" onpropertychange="if(this.scrollHeight>80) this.style.posHeight=this.scrollHeight+5" placeholder="请输入需求内容"></textarea>
						</div> -->
						<div class="form-group">
							<label for="" class="ml">跟进情况：</label>
							<textarea style="resize:none" id="contenta" class="checkacc" name="customerFormMap.content" rows="6" cols="60" onpropertychange="if(this.scrollHeight>80) this.style.posHeight=this.scrollHeight+5" placeholder="请输入跟进内容"></textarea>
						</div>
					<!-- 	<div class="form-group">
