...
import com.first.util.SplitString;
...
public class PersonalServiceImpl implements PersonalService {
    ...
    @Override
    public PersonalFormMap findallnextdayadd(Map searchMap) {
        return personalMapper.findallnextdayadd(searchMap);
    }

    @Override
    public List<HashMap> peDealPerformance(Map searchMap) {
        return personalMapper.peDealPerformance(searchMap);
    }
    ...
    @Override
    public PersonalFormMap findalldayreport(Map searchMap) {
        return personalMapper.findalldayreport(searchMap);
    }
    @Override
    public PersonalFormMap findallweekreport(Map searchMap) {
        return personalMapper.findallweekreport(searchMap);
    }

    @Override
    public PersonalFormMap findallmonthreport(Map searchMap) {
        return personalMapper.findallmonthreport(searchMap);
    }
    @Override
    public  void delayedSendWeChat () throws ParseException {
        ...
        PersonalFormMap daylisR = findalldayreport(searchMap); //日数据
        PersonalFormMap daylisP =  findallnextdayadd(searchMap); //日数据
...
*/
        ...
        List<String> d = SplitString.getStrList(info, 600);
