...
public class ProjectController extends BaseController {
    ...
    public String listUI(Model model) throws Exception {
        model.addAttribute("resShops", findByRes("67","1"));
        model.addAttribute("resApartment", findByRes("67","2"));
        model.addAttribute("resOffice", findByRes("67","3"));
        model.addAttribute("resHome", findByRes("67","4"));
    ...
    public List<ResFormMap> findByRes(String parentId,String icon){

        ResFormMap resQueryForm = new ResFormMap();
        resQueryForm.put("parentId", parentId);
        resQueryForm.put("userId", getuserId());
        resQueryForm.put("icon", icon);
    ...
    public String editEntity() throws Exception {
        ProjectFormMap projectFormMap = getFormMap(ProjectFormMap.class);
        System.err.println("da"+projectFormMap);
...
/*    *//**
    ...
    public List<ProjectShopsFormMap> showProvince() {
        Map<String, Object> searchMap = new HashMap<String, Object>();
        searchMap.put("state",4);
        List<ProjectShopsFormMap> ProjectShopsFormMap = projectShopsService.findProjectShops(searchMap);
