...
<body>
	...
	<form id="form" name="form" class="form-horizontal" method="post"
		...
		<div class="panel-body">
			...
			<div class="form-group">
				<label class="col-sm-3 control-label">房源发布</label>
				<div class="col-sm-9">
					<input id="register_1" type="radio" checked="checked" value="1"
						   name="userFormMap.register" />注册&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input id="register_2" type="radio" value="2" name="userFormMap.register" />不注册
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
